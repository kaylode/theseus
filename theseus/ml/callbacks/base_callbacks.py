...
class Callbacks:
    ...
    def __init__(self) -> None:
        ...
        self._hooks = {k: None for k in hook_names}
    ...
    def register_hook(
        self, func: Any = None, prefix: str = "", overide: bool = False
    ) -> Any:
        """
    ...
    def get(self, name: str) -> Any:
        ...
        if ret is None:
            raise KeyError(
                "Hook named '{}' has not been registered in '{}'!".format(
                    name, self._name
                )
            )
        return ret
...
class CallbacksList:
    ...
    def __init__(self, callbacks: List[Callbacks]):
        ...
        # Define the available callbacks
        self._callbacks = {k: [] for k in hook_names}
    ...
    def run(self, hook, params: Dict = None):
        ...
        assert (
            hook in self._callbacks.keys()
        ), f"hook {hook} not found in callbacks in {self._callbacks.keys()}"
