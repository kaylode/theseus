from typing import Any, Callable, List, Dict, Mapping, Optional, Union
...
class LightningModelWrapper(pl.LightningModule):
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        self.log_dict(self.metric_dict, prog_bar=True, batch_size=self.datamodule.valloader.batch_size)
