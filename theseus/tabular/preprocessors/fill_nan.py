...
class FillNaN(Preprocessor):
    def __init__(self, column_names=None, fill_with='mean', verbose=False, **kwargs):
    ...
    def run(self, df):
        ...
        for column_name in self.column_names:
            ...
            if self.fill_with == 'interpolate':
                df[column_name] = fill_with_interpolation(df, column_name, self.interpolate_method_name)
