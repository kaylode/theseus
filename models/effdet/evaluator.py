...
from .evaluation.detection_evaluator import ObjectDetectionEvaluator, PascalDetectionEvaluator, OpenImagesDetectionEvaluator
...
class TfmEvaluator(Evaluator):
    ...
    def __init__(
            self, dataset, distributed=False, pred_yxyx=False, evaluator_cls=ObjectDetectionEvaluator):
        super().__init__(distributed=distributed, pred_yxyx=pred_yxyx)
...
class PascalEvaluator(TfmEvaluator):
    ...
    def __init__(self, dataset, distributed=False, pred_yxyx=False):
        super().__init__(
            dataset, distributed=distributed, pred_yxyx=pred_yxyx, evaluator_cls=PascalDetectionEvaluator)
...
class OpenImagesEvaluator(TfmEvaluator):
    ...
    def __init__(self, dataset, distributed=False, pred_yxyx=False):
        super().__init__(
            dataset, distributed=distributed, pred_yxyx=pred_yxyx, evaluator_cls=OpenImagesDetectionEvaluator)
