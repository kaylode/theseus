...
class EfficientDetV2(nn.Module):
    ...
    def detect(self, x, anchors, regression, classification, regressBoxes, clipBoxes, threshold=0.0001):
        ...
        for i in range(x.shape[0]):
            ...
            boxes_ = transformed_anchors[i, scores_over_thresh[i, :], ...]     # [84, 4]
